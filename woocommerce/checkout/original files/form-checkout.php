...
?>
<div class="checkout-wrapper product-details">
    <div class="checkout-top">
        <h2 class="desktop-only"><img src="/wp-content/uploads/checkout-cart-icon.png"><span>Your Cart: </span>Summary</h2>
        
        <div>
            <div class="checkout-phone">
                <img src="/wp-content/uploads/woocommerce-checkout-phone-icon.png">
                    <a href="tel:1800936774">1800 936 774<span>Order by phone</span></a>
            </div>
            <div class="eway_content">
        	    <a href="https://www.eway.com.au/secure-site-seal?i=11&amp;s=7&amp;pid=2922a381-ddf7-48c5-a343-4e41fb8267df" target="_blank" nofollow><img alt="eWAY Payment Gateway" src="https://www.eway.com.au/developer/payment-code/verified-seal.php?img=11&amp;size=3&amp;theme=0"></a>
            </div>
            <div class="show-on-demo">
                <img src="/wp-content/uploads/emergency-alarm-free-programming-1-1.png">
            </div>
        </div>
        <h2 class="mobile-only"><img src="/wp-content/uploads/checkout-cart-icon.png"><span>Your Cart: </span>Summary</h2>
    </div>
    <!-- Cart contents -->
    ...
    <!-- Form checkout -->
    <h2 class="checkout-heading"><span>Billing </span>& <span>Shipping:</span></h2>
    <form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
        ...
        <div class="checkout-section">
            <h2 class="checkout-heading"><span>Programming </span>Information</h2>
    ...
    <div class="boxed-form postage-notes checkout-txt-box">
        <h2 class="checkout-heading"><span>Postage </span>Notes</h2>
        <div>
            <p><strong>Mobile Alarm</strong></p>
            <p><?php date_default_timezone_set('Australia/Sydney'); $tz =new DateTimeZone('Australia/Sydney'); $dt = new DateTime(); $dt->setTimezone($tz); echo $dt->format('j M Y'); ?> – You should expect your Live Life Alarm to be shipped with Australia Post Express within 4-5 business days of your order, however, we will try our best to send your alarm sooner if we can.</p>
        </div>
    </div>
    <!-- Postage notes -->
</div>